...
export function SimpleUpdate() {
  ...
  const getPinFeeText = () => {
    if (formData.format === "Token") {
      return "Free (No IPFS pinning required)";
    }
          ...
          <>
            ...
            {formData.format === "ARC3" ? (
              ...
              <>
                ...
                {/* Cost Summary Box */}
                <div className="w-full bg-orange-500/5 p-4 rounded-xl border border-orange-500/20 text-sm my-4 text-left">
                  ...
                  <ul className="space-y-1 text-xs text-gray-300">
                    {effectiveProvider === "algofile" ? (
                      <>
                        ...
                        <li className="opacity-70">• Secondary Option (Crust Pinning): <span className="font-semibold text-white/85">1.4 ALGO per pin ({formData.format === "ARC69" ? "1 pin: image" : "2 pins: image + JSON"} = {formData.format === "ARC69" ? "1.4 ALGO" : "2.8 ALGO"})</span></li>
                      </>
                    ) : effectiveProvider === "crust" ? (
                      <>
                        <li>• Pinning Fee (Crust): <span className="font-semibold text-white">1.4 ALGO per pin ({formData.format === "ARC69" ? "1 pin: image" : "2 pins: image + JSON"} = {formData.format === "ARC69" ? "1.4 ALGO" : "2.8 ALGO"})</span></li>
