...
export abstract class Arc59CallFactory {
  ...
  static arc59GetSendAssetInfo(
    args: MethodArgs<"arc59_getSendAssetInfo(address,uint64)(uint64,uint64,bool,bool,uint64,uint64)">,
    params: AppClientCallCoreParams & CoreAppCallArgs
  ) {
    return {
      method:
...
export type Arc59Composer<TReturns extends [...any[]] = []> = {
  ...
  arc59GetSendAssetInfo(
    ...
    [
      ...TReturns,
      MethodReturn<"arc59_getSendAssetInfo(address,uint64)(uint64,uint64,bool,bool,uint64,uint64)">
    ]
  >;
